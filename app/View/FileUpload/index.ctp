<div class="row-fluid">
	...
	<p>Complete the File Upload feature and import the attached
		<?php echo $this->Html->link('<i class="icon-share
	...
	<table class="table table-bordered table-striped">
		...
		<tbody>
			<?php foreach ($file_uploads as $file_upload): ?>
				<tr>
					<td>
						<?php echo $file_upload['FileUpload']['id']; ?>
					</td>
					<td>
						<?php echo $file_upload['FileUpload']['name']; ?>
					</td>
					<td>
						<?php echo $file_upload['FileUpload']['email']; ?>
					</td>
					<td>
						<?php echo $file_upload['FileUpload']['created']; ?>
					</td>
				</tr>
			<?php endforeach; ?>
		</tbody>
